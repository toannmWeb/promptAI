# GEMINI.md — Entry file for Google Gemini

> File này là entry point cho Gemini (Code Assist / Gemini CLI / Gemini in IDE).
>
...
- **Gemini Code Assist (IDE)**: cấu hình project rules trong settings → "Custom instructions" → paste section "5 rules" ở trên + đường dẫn đến AGENTS.md.
- **Gemini CLI**: `gemini --rules-file GEMINI.md` (hoặc xem CLI docs).
- **Gemini Web/API**: dùng system prompt = nội dung file này.
